...
Revision ID: ec2a2a53bbcf
Revises: 
Create Date: 2018-02-13 08:33:01.627776
...
def upgrade():
    ...
    op.create_table('cform',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('firstnamn', sa.String(length=128), nullable=True),
